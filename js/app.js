...
function createApp(data) {
    new Vue({
        ...
        computed: {
            ...
            filteredList() {
                const filteredByCategory = this.category === 'all' ? (this.logos) : (this.logos.filter(logo => {
                ...
                return filteredByCategory.filter(logo => {
                    return logo.name.toLowerCase().includes(this.search.toLowerCase()) || logo.category.toLowerCase().includes(this.search.toLowerCase())
                })
            }
        }
    })
